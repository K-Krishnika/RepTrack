    ...
    if result.pose_landmarks:
        ...
        if len(sequence) == 30:
            ...
            if stable_prediction == target_exercise:
                ...
                # =================================
                ...
                elif target_exercise == "jumping_jack":
                    ...
                    legs_open = ankle_distance > 0.35

                    print(
                        f"Arms Open: {arms_open}, "
                        f"Ankle Distance: {ankle_distance:.3f}, "
                        f"Legs Open: {legs_open}, "
                        f"Stage: {jumping_stage}"
                    )
                    ...
                    # CLOSED position
                        ...
                        jumping_stage = "CLOSED"

                        rep_count += 1

                        print(
                            f"Jumping Jack Rep Count: {rep_count}"
                        )               
